...
package com.demo.db.transaction.ibatisAndjdbc.ext.spring;
...
/**
 * 因为父类的sqlMapClient是私有的，导致无法覆盖，只能重写
 */
public class SqlMapClientFactoryBeanOur extends SqlMapClientFactoryBean {
	...
	public SqlMapClientFactoryBeanOur() {
	...
	public SqlMapClient getObject() {
		return  new SqlMapClientImplOur(this.sqlMapClient ,((SqlMapClientImpl)this.sqlMapClient).getDelegate() );
	}
